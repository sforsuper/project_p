  ...
  setsockopt(sock, SOL_SOCKET, SO_REUSEADDR,
    ...
    inline std::string to_string(const Error error) {
        switch (error) {
            ...
            case Error::SSLServerVerification: return "SSL m_server verification failed";
      ...
      return;
        ...
        inline const char *status_message(int status) {
            switch (status) {
                ...
                case 511: return "Server Authentication Required";
            ...
            while (svr_sock_ != INVALID_SOCKET) {
                ...
                if (sock == INVALID_SOCKET) {
                    ...
                    if (svr_sock_ != INVALID_SOCKET) {
                        ...
                        ; // The m_server socket was closed by user.
                    }
                    break;
                }
...
// SSL HTTP m_server implementation
